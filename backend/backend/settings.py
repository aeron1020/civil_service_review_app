...
GOOGLE_CLIENT_ID = os.environ.get("GOOGLE_CLIENT_ID", "635060906660-2vnkcrum87ealqjjgpg7bqlspaiggnnk.apps.googleusercontent.com")

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/4.2/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-468xfhjl8+j668#vo%gol)kqmd!7pd@_*blzrd2q*#2-ua)x6+'
...
REST_FRAMEWORK = {
    # Permissions (default open for now)
...
# LOGIN/LOGOUT redirect (optional)
LOGIN_REDIRECT_URL = "/"
LOGOUT_REDIRECT_URL = "/"